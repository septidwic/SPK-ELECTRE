        ...
        <form method="post">
           <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input class="form-control" type="text" name="bobot" value="<?=set_value('alamat', $row->alamat_alternatif)?>"/>
            </div>  
			<div class="form-group">
                <label>Tahun<span class="text-danger"></span></label>
               <input class="form-control" type="text" name="bobot" value="<?=set_value('tahun', $row->tahun)?>"/>
            </div> 
            <div class="form-group">
